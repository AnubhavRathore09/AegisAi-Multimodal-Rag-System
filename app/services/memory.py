...
class ChatMemoryStore:
    ...
    def _load_fallback(self) -> None:
        ...
        for user_id, sessions in raw_messages.items():
            self._fallback_messages[user_id] = {}
            for session_id, records in dict(sessions).items():
                self._fallback_messages[user_id][session_id] = [self._deserialize_record(record) for record in records]
    ...
    def _save_fallback(self) -> None:
        payload = {
            ...
            "messages": {
                ...
                for user_id, sessions in self._fallback_messages.items()
            },
        }
