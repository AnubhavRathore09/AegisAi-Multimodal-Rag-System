...
TEMPLATE_INSTRUCTIONS = {
    ...
    "generate_prompt": "Answer naturally in short readable paragraphs.",
    "live_news_prompt": "Use the live news context first, focus on recency, and mention uncertainty briefly if the feed looks incomplete.",
